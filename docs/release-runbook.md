...
3. Pick the next version tag, for example `v0.4.20`.
4. Build the app bundle:
   - `cd ~/Downloads/maclev`
   - `env APP_VERSION=0.4.20 APP_BUILD_NUMBER=0.4.20 OPEN_APP=0 ./build_app.sh`
5. Package the app bundle:
   - `ditto -c -k --sequesterRsrc --keepParent build/.bundle/maclev.app ~/Downloads/homebrew-maclev/artifacts/maclev-0.4.20.zip`
6. Compute the checksum:
   - `shasum -a 256 ~/Downloads/homebrew-maclev/artifacts/maclev-0.4.20.zip`
